...
const navItems = [
  ...
  { href: '/admin-dashboard/employees', icon: <FileText className="h-5 w-5" />, label: 'Submissions' },
  { href: '/admin-dashboard/payroll', icon: <Users className="h-5 w-5" />, label: 'Reviewers' },
  { href: '/admin-dashboard/leaves', icon: <Archive className="h-5 w-5" />, label: 'Archive' },
];
